...
# # len1 = 30000
# # train = proc[:24000]
# # val = proc[24000:27000]
# # test = proc[27000:30000]
...
# )
proc_generator = get_features_label(proc, batch_size=16)
...
# inception.save('inception_ftune.h5')
# inception = load_model('/content/drive/My Drive/inception_ftune.h5')
inception = load_model('inception_ftune_2.h5')

# predIdxs = inception.predict_generator(val_generator,
# 	steps=val_steps+1)
# predIdxs = np.argmax(predIdxs, axis=1)

# inception.evaluate_generator(val_generator,steps=val_steps)
...
with open('finetuned_inception_embeddings.pckl','wb') as h:
    pk.dump(data,h)
# inception.summary()
